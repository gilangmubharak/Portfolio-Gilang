...
export const projectsData = [
    {
        id: 1,
        projectName: 'E-Rkam Management',
        projectDesc: 'Proyek ini bertujuan untuk membangun sistem manajemen madrasah yang mengkonsolidasikan semua informasi suatu perusahaan.',
        tags: ['React', 'Spring'],
    ...
    {
        id: 3,
        projectName: 'Popular Movie Catalog',
        projectDesc: 'Popular Movie adalah aplikasi Android Movie katalog film tempat Anda dapat menemukan film yang sedang tren dari berbagai parameter.',
